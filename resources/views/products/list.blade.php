...
@section('content')
    ...
    <section class="breadcrumb-section set-bg" data-setbg="img/blog/details/details-hero.webp">
        <div class="container">
            <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg"
                                    data-setbg="@if ($product->images != null && count($product->images) > 0) {{ Storage::url($product->images[0]) }} @else img/product/product-1.jpg @endif">
