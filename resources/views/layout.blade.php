...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> shraniksangat9@gmail.com</li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./home"><img src="img/grocery-logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: jayabageshwori,Kathmandu</li>
                            <li>Phone: 9813570126</li>
                            <li>Email: shraniksangat9@gmail.com</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 offset-lg-1">
                    <div class="footer__widget">
                        <h6 style="color: rgb(190, 98, 12);">Useful Links</h6>
                        <ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer__copyright">
                        ...
                        <div class="footer__copyright__payment"><img src="img/khalti.png" alt=""
