...
@section('content')
    <h1 style="text-align:center; color:burlywood;">Product detail:</h1>
    <marquee behavior="" direction="" style="width:80%;  color:burlywood;">All products are fresh and
        ready. We offer high
        quality products</marquee>
    {{-- <!-- Hero Section Begin -->
